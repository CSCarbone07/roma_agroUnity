Shader "Ciconia Studio/Double Sided/Transparent/Diffuse Bump Cutout Lerp" {
    Properties {
...
////// Specular:
                ...
                float3 diffuseColor = (_MainTex_var.rgb*_Color.rgb * tex2D(_TexNoise, TRANSFORM_TEX(i.uv0, _TexNoise))) + (_MainTex_var.rgb*_Color2.rgb * ((1,1)-tex2D(_TexNoise, TRANSFORM_TEX(i.uv0, _TexNoise))));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float3 diffColor = (_MainTex_var.rgb*_Color.rgb * tex2D(_TexNoise, TRANSFORM_TEX(i.uv0, _TexNoise))) + (_MainTex_var.rgb*_Color2.rgb * ((1,1)-tex2D(_TexNoise, TRANSFORM_TEX(i.uv0, _TexNoise))));
                float4 _SpecGlossMap_var = tex2D(_SpecGlossMap,TRANSFORM_TEX(i.uv0, _SpecGlossMap));
