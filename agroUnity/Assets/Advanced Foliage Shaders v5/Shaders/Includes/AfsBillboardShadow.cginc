...
//	this fixex the trunk on the terrain and aligns the billboard to the camera
	...
	//const float3 forwardVector = -UNITY_MATRIX_IT_MV[2].xyz / UNITY_PI; // camera forward
	//pos.xyz += forwardVector * copyoffset_y * (halfPI + billboardAngleFactor );
